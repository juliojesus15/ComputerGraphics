...
int main()
{
    ...
    // --------------------
    GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "Trabajo 006: Vitral - Animaciones", NULL, NULL);
    if (window == NULL)
    {
    ...
    std::cout << "1) Presionar Q: Rotación automatica" << std::endl;
    std::cout << "1) Presionar Q: Detener rotación automatica" << std::endl;
    std::cout << "=====================================================" << std::endl;
    std::cout << "Escala" << std::endl;
    std::cout << "1) Presionar A: Aumenta la escala" << std::endl;
    std::cout << "2) Presionar D: Disminuir la escala" << std::endl;
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        if(activar_rotacion) {
            vitral.rotacion(glm::vec3(0.0f, 0.0f, 1.0f));     
...
void key_callback(GLFWwindow* window, int key, int scancode, int action, int mods) {
    if (key == GLFW_KEY_Q && action == GLFW_PRESS) activar_rotacion = !activar_rotacion;
    else if (key == GLFW_KEY_A && action == GLFW_PRESS) vitral.escala(true);
    else if (key == GLFW_KEY_D && action == GLFW_PRESS) vitral.escala(false);
}
