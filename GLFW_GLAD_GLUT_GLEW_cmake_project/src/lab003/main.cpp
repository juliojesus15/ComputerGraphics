...
{   
    ...
    // --------------------
    GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "Computacion Grafica (Lab003) - UCSP", NULL, NULL);
    if (window == NULL)
    {
...
void key_callback(GLFWwindow* window, int key, int scancode, int action, int mods) {
    ...
    else if (key == GLFW_KEY_W && action == GLFW_PRESS && idx_figura == 1 ) triangulo.axis_y(true);
    else if (key == GLFW_KEY_S && action == GLFW_PRESS && idx_figura == 1 ) triangulo.axis_y(false);
    else if (key == GLFW_KEY_D && action == GLFW_PRESS && idx_figura == 1 ) triangulo.axis_x(true);
    else if (key == GLFW_KEY_A && action == GLFW_PRESS && idx_figura == 1 ) triangulo.axis_x(false);

    else if (key == GLFW_KEY_W && action == GLFW_PRESS && idx_figura == 2) estrella.axis_y(true);
    else if (key == GLFW_KEY_S && action == GLFW_PRESS && idx_figura == 2) estrella.axis_y(false);
    else if (key == GLFW_KEY_D && action == GLFW_PRESS && idx_figura == 2) estrella.axis_x(true);
    else if (key == GLFW_KEY_A && action == GLFW_PRESS && idx_figura == 2) estrella.axis_x(false);

    else if (key == GLFW_KEY_W && action == GLFW_PRESS && idx_figura == 3) pizza.axis_y(true);
    else if (key == GLFW_KEY_S && action == GLFW_PRESS && idx_figura == 3) pizza.axis_y(false);
    else if (key == GLFW_KEY_D && action == GLFW_PRESS && idx_figura == 3) pizza.axis_x(true);
    else if (key == GLFW_KEY_A && action == GLFW_PRESS && idx_figura == 3) pizza.axis_x(false);
}
